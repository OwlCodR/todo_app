...
mixin _$TasksResponse {
  ...
  @JsonKey(name: 'list')
  List<ElementResponse> get tasks => throw _privateConstructorUsedError;
...
abstract class $TasksResponseCopyWith<$Res> {
  ...
  $Res call(
      ...
      @JsonKey(name: 'list') List<ElementResponse> tasks,
...
class _$_TasksResponse implements _TasksResponse {
  _$_TasksResponse(
      ...
      @JsonKey(name: 'list') required final List<ElementResponse> tasks,
  ...
  @JsonKey(name: 'status')
  final String status;
  final List<ElementResponse> _tasks;
  @override
  @JsonKey(name: 'list')
  List<ElementResponse> get tasks {
